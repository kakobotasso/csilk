...
before_filter :authenticate_user!
  ...
  # GET /contatos.json
  def index
    @contatos = Contato.all.sort! { |a,b| b.id <=> a.id }
  ...
  def create
    ...
    respond_to do |format|
      if @contato.save
        format.html { redirect_to [:admin, @contato], notice: 'Contato was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @contato.update_attributes(params[:contato])
        format.html { redirect_to [:admin, @contato], notice: 'Contato was successfully updated.' }
