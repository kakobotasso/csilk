class Admin::FornecedoresController < Admin::AdminController
layout 'admin'  
before_filter :authenticate_user!
  # GET /fornecedores
  # GET /fornecedores.json
  def index
    @fornecedores = Fornecedor.all.sort! { |a,b| b.id <=> a.id }
  ...
  def create
    ...
    respond_to do |format|
      if @fornecedor.save
        format.html { redirect_to [:admin, @fornecedor], notice: 'Fornecedor was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @fornecedor.update_attributes(params[:fornecedor])
        format.html { redirect_to [:admin, @fornecedor], notice: 'Fornecedor was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_fornecedores_url }
      format.json { head :no_content }
    end
  end
end
